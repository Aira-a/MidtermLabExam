...
(1, 'Aira', 'Austria', 'Quitlong', 123, 'Bagumbayan', 'San Jose', 'Batangas', 'CALABARZON', 'Philippines', '2005-04-15', 19, '09171234567', 'aira@email.com', 'Mery', 'Austria', 'Reading, Dancing', 'Airaganda', 1, 2),
(2, 'Kitkat', 'Maya', 'Reyes', 456, 'Sampaguita', 'Lipa', 'Batangas', 'CALABARZON', 'Philippines', '2004-09-20', 20, '09172345678', 'kitkat@email.com', 'Jose', 'Santos', 'Painting, Swimming', 'kiki', 2, 3),
(3, 'Jazten', 'Cruz', 'Garcia', 789, 'Tingting', 'Batangas City', 'Batangas', 'CALABARZON', 'Philippines', '2003-12-01', 21, '09173456789', 'jaz@email.com', 'Ana', 'Cruz', 'Cooking, Zumba', 'JazDoIt', 3, 4),
(4, 'Ana', 'Villanueva', 'Tan', 101, 'Kalayaan', 'Balayan', 'Batangas', 'CALABARZON', 'Philippines', '2005-05-18', 19, '09174567890', 'ana.villanueva@email.com', 'Ricardo', 'Villanueva', 'Dancing, Hiking', 'Anita', 4, 2),
(5, 'Luis', 'Perez', 'Alvarez', 202, 'Mabini', 'Nasugbu', 'Batangas', 'CALABARZON', 'Philippines', '2004-02-10', 21, '09175678901', 'luis.perez@email.com', 'Cristina', 'Perez', 'Jogging, Reading', 'Lui', 1, 3);
